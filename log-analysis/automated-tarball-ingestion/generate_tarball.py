...
class GenerateTarball:
    ...
    - includes output of NodeAnalyzer/TableAnalyzer tools (which themselves are simply running a series of nodetool commands on each node)
    """
    client_name = ""
    tarball_filename = ""
